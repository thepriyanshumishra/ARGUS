...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      activeTarget = target;
      const corners = Array.from(cornersRef.current);
      corners.forEach((corner) => gsap.killTweensOf(corner, { properties: "x,y" }));

      gsap.killTweensOf(cursorRef.current, { properties: "rotation" });
      ...
      const leaveHandler = () => {
        ...
        if (cornersRef.current) {
          const corners = Array.from(cornersRef.current);
          gsap.killTweensOf(corners, { properties: "x,y" });
